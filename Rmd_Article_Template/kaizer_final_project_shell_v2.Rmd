...
dat$GENDERf <- factor(dat$GENDER, levels=c('m','f'), labels=c('Male','Female'))
dat$ETHNICf <- factor(dat$ETHNIC, levels=c('w','b','h','o'), labels=c('White','Black','Hispanic','Other'))
...
kbl( tab1_forkbl,
     ...
     col.names = c('Budesonide','Nedocromil','Albuterol'))  %>%
  add_indent(4:7) %>%
  kable_styling(latex_options = "HOLD_position", font_size = 4.5) # ADDED font_size ARGUMENT AND MADE MUCH SMALLER
```
...
:::::::::::::: {.columns data-latex=""}
::: {.column width="40%" data-latex=""}
contents...
:::
::: {.column width="60%" data-latex=""}
contents...
:::
::::::::::::::
